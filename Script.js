...
function whatsapp_Share(){
   ...
   let url = "whatsapp://send?text=Intenta+escapar+del+laberinto+y+superarme%21+%0A%26%2326A1+Movimientos+-%3E+"
    ...
    console.log(url);
    document.getElementById("whatsapp-share").setAttribute('href',"whatsapp://send?text=Intenta escapar del laberinto y superarme " + "%0a🟧 Movimientos -> " + counter + "%0a⏳ Segundos -> " + time + "%0a https://marcodiazz.github.io/Laberynth/index.html#");
}
